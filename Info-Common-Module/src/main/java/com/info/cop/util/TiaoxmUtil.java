...
public class TiaoxmUtil {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("开始转化条形码");
            BufferedImage image = TiaoxmUtil.getBarCodeWithWords("310-310-B05-610", "1233629939062", "", "", "");
            os = new ByteArrayOutputStream();
            // 转入输出流
            ImageIO.write(image, "png", os);

            // 直接导出到本地
            ImageIO.write(image, "jpg", new File("C:\\Users\\Administrator\\Desktop\\AAAA.jpg"));
            inputStream = new ByteArrayInputStream(os.toByteArray());
            System.out.println("条形码转化结束");
        } catch (Exception e) {
        } finally {
            if (inputStream != null) {
                try {
     ...
     * 默认图片宽度
     */
    private static final int DEFAULT_PICTURE_WIDTH = 220;
     ...
     * 默认条形码宽度
     */
    private static final int DEFAULT_BAR_CODE_WIDTH = 160;
